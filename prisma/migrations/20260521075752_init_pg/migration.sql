...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_userId_productId_specInfo_key" ON "CartItem"("userId", "productId", "specInfo");
...
-- CreateIndex
CREATE UNIQUE INDEX "UserBinding_type_identifier_key" ON "UserBinding"("type", "identifier");
...
-- AddForeignKey
ALTER TABLE "UserBinding" ADD CONSTRAINT "UserBinding_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
