      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl shadow-sakura-500/10 p-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-400 mt-1">发现你喜爱的动漫好物</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="accent-sakura-500 rounded" />
                记住我
              </label>
              <Link href="/reset-password" className="text-sakura-500 hover:underline">
                忘记密码？
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative text-center mb-4">
              ...
              <span className="relative bg-white px-4 text-xs text-gray-300">
                其他登录方式
              </span>
            </div>
            ...
            <div className="flex justify-center gap-6">
              ...
              <button
                ...
                className="w-11 h-11 rounded-full flex items-center justify-center bg-white border-2 border-gray-200 transition-transform hover:scale-110"
                title="Google登录"
              >
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            还没有账号？{" "}
            <Link href="/register" className="text-sakura-500 font-medium hover:underline">
              立即注册
            </Link>
          </p>
        </div>
